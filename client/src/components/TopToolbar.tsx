...
// Blueprint Dark Theme: plan management, room focus, dimensions
// ============================================================
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        <button
          ...
          onClick={() => { setShowPlansMenu(!showPlansMenu); setShowRoomMenu(false); setShowDimensions(false); }}
        >
          <FolderOpen size={12} />
      ...
      <div style={{ position: "relative" }}>
        <button
          ...
          onClick={() => { setShowRoomMenu(!showRoomMenu); setShowPlansMenu(false); setShowDimensions(false); }}
        >
          <Eye size={12} />
      ...
      {(showPlansMenu || showRoomMenu || showDimensions) && (
        <div
          style={{ position: "fixed", inset: 0, zIndex: 150 }}
          onClick={() => { setShowPlansMenu(false); setShowRoomMenu(false); setShowDimensions(false); }}
        />
      )}
    </div>
  );
